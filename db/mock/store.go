...
// Source: sgithub.com/techschool/simplebank/db/sqlc (interfaces: Store)
...
// ListAccountsByName mocks base method.
func (m *MockStore) ListAccountsByName(arg0 context.Context, arg1 db.ListAccountsByNameParams) ([]db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListAccountsByName", arg0, arg1)
	ret0, _ := ret[0].([]db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListAccountsByName indicates an expected call of ListAccountsByName.
func (mr *MockStoreMockRecorder) ListAccountsByName(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAccountsByName", reflect.TypeOf((*MockStore)(nil).ListAccountsByName), arg0, arg1)
}
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 db.CreateTransferParams) (db.TransferResultType, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferTx", arg0, arg1)
	ret0, _ := ret[0].(db.TransferResultType)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) VerifyEmailTx(arg0 context.Context, arg1 db.UpdateVerifyEmailParams) (*db.User, *db.VerifyEmail, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "VerifyEmailTx", arg0, arg1)
	ret0, _ := ret[0].(*db.User)
	ret1, _ := ret[1].(*db.VerifyEmail)
	ret2, _ := ret[2].(error)
